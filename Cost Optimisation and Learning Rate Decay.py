# -*- coding: utf-8 -*-
"""cost optimization_methods and learning rate decay.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1YQJmkpYZlI7fDRb_P7tSPtz0WUJOnKIL
"""
...
def random_mini_batches(X, Y, mini_batch_size = 64, seed = 0):
    ...
    if m % mini_batch_size != 0:
        rem_ex=m-(num_complete_minibatches*mini_batch_size)
        mini_batch_X=shuffled_X[:,(m-rem_ex):m]
        mini_batch_Y=shuffled_Y[:,(m-rem_ex):m]
        mini_batch = (mini_batch_X, mini_batch_Y)
        mini_batches.append(mini_batch)
...
def update_parameters_with_adam(parameters, grads, v, s, t, learning_rate = 0.01,
    ...
    for l in range(1, L + 1):
        ...
        v_corrected["dW"+str(l)]=np.divide(v["dW"+str(l)],(1-np.power(beta1,t)))
        v_corrected["db"+str(l)]=np.divide(v["db"+str(l)],(1-np.power(beta1,t)))
        s["db"+str(l)]=beta2*s["db"+str(l)]+(1-beta2)*np.square((grads["db"+str(l)]))
        s["dW"+str(l)]=beta2*s["dW"+str(l)]+(1-beta2)*np.square((grads["dW"+str(l)]))
        s_corrected["dW"+str(l)]=np.divide(s["dW"+str(l)],(1-np.power(beta2,t)))
        s_corrected["db"+str(l)]=np.divide(s["db"+str(l)],(1-np.power(beta2,t)))
...
"""Lets train 3-layered neural network with:
...
Lets apply scheduled learning rate decay to a 3-layer neural network in three different optimizer modes and see how each one differs, as well as the effect of scheduling at different epochs.
"""
